            ...
            <section>
                <div class="sttabs tabs-style-line">
                    <div class="white-box">
                        <nav>
                            <ul>
                                <li class="tab-current"><a href="{{ route('client.projects.show', $project->id) }}"><span>Overview</span></a></li>
                                <li><a href="{{ route('client.project-members.show', $project->id) }}"><span>Members</span></a></li>
                                <li><a href="{{ route('client.issues.show', $project->id) }}"><span>Issues</span></a></li>
                                <li><a href="{{ route('client.files.show', $project->id) }}"><span>Files</span></a></li>
                                <li><a href="{{ route('client.time-log.show', $project->id) }}"><span>Time Logs</span></a></li>
                                <li><a href="{{ route('client.project-invoice.show', $project->id) }}"><span>Invoices</span></a></li>
                            </ul>
                        </nav>
                    </div>
