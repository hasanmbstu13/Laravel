                    ...
                    <div class="white-box">
                        <nav>
                            <ul>
                                ...
                                <li><a href="{{ route('client.time-log.show', $project->id) }}"><span>@lang('app.enu.timeLogs')</span></a></li>
                                <li class="tab-current"><a href="{{ route('client.project-invoice.show', $project->id) }}"><span>@lang('app.menu.issues')</span></a></li>
                            </ul>
                        </nav>
                    </div>
