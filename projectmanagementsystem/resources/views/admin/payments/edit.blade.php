                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control" data-placeholder="@lang('modules.payments.selectInvoice')" name="invoice_id">
                                            @foreach($invoices as $invoice)
                                                <option
                                                        @if($payment->invoice_id == $invoice->id) selected @endif
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="paid_on"  id="paid_on" @if(is_null($payment->paid_on)) value="{{ Carbon\Carbon::today()->format('m/d/Y') }}" @else value="{{ $payment->paid_on->format('m/d/Y') }}" @endif>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="switchery-demo">
                                            <input type="checkbox" @if($payment->invoice->status == 'paid') checked @endif name="invoice_paid" class="js-switch " data-color="#00c292" data-secondary-color="#f96262"  />
                                        </div>
                                    </div>
                                </div>
                            </div>
