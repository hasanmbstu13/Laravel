        ...
        <div class="col-md-12">
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <a href="{{ route('project-admin.all-tasks.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.tasks.newTask') <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function showTable() {
        ...
        var url = '{!!  route('project-admin.all-tasks.data', [':startDate', ':endDate', ':hideCompleted', ':projectId']) !!}';
    ...
    $('body').on('click', '.sa-params', function () {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('project-admin.all-tasks.destroy',':id') }}";
