                ...
                <div class="sttabs tabs-style-line">
                    <div class="white-box">
                        ...
                        <nav>
                            <ul>
                                ...
                                <li class="tab-current"><a href="{{ route('project-admin.tasks.show', $project->id) }}"><span>@lang('app.menu.tasks')</span></a></li>
                    ...
                    <div class="content-wrap">
                                                ...
                                                <li class="list-group-item @if($task->status == 'completed') task-completed @endif">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-2 text-right">
                                                            ...
                                                            {!! ($task->user->image) ? '<img data-toggle="tooltip" data-original-title="' . ucwords($task->user->name) . '" src="' . asset('storage/avatar/' . $task->user->image) . '"
                        ...
                        alt="user" class="img-circle" height="35"> ' !!}
                                ...
                                <div class="col-md-4 hide" id="new-task-panel">
...
<script type="text/javascript">
    ...
    $('#save-task').click(function () {
        $.easyAjax({
            url: '{{route('project-admin.tasks.store')}}',
    ...
    taskListPanel.on('click', '.edit-task', function () {
        ...
        var url = "{{route('project-admin.tasks.edit', ':id')}}";
    ...
    taskListPanel.on('click', '.task-check', function () {
        ...
        var id = $(this).data('task-id');
        var url = "{{route('project-admin.tasks.changeStatus')}}";
    ...
    $('#sort-task, #hide-completed-tasks').change(function() {
        ...
        var url = "{{route('project-admin.tasks.sort')}}";
        var token = "{{ csrf_token() }}";
