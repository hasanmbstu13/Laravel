                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group">
                            <a href="{{ route('project-admin.projects.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.projects.addNewProject') <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                    ...
                    <div class="col-sm-6 text-right">
                        <div class="form-group">
                            <a href="{{ route('project-admin.projects.export') }}" class="btn btn-info btn-sm"><i class="ti-export" aria-hidden="true"></i> @lang('app.exportExcel')</a>
                        </div>
                    </div>
                </div>
...
<script>
    $(function() {
        var table = $('#project-table').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('project-admin.projects.data') !!}',
            "order": [[ 0, "desc" ]],
            deferRender: true,
            language: {
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('project-admin.projects.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
        ...
        $('#createProject').click(function(){
            var url = '{{ route('project-admin.projectCategory.create')}}';
