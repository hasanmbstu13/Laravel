                    ...
                    <div class="white-box">
                        <nav>
                            <ul>
                                ...
                                <li class="tab-current"><a href="{{ route('project-admin.project-members.show', $project->id) }}"><span>@lang('modules.projects.members')</span></a></li>
...
//    })();
    ...
    $('#save-members').click(function () {
        $.easyAjax({
            url: '{{route('project-admin.project-members.store')}}',
...
$('body').on('click', '.delete-members', function(){
    ...
    swal({
        ...
        if (isConfirm) {
            ...
            var url = "{{ route('project-admin.project-members.destroy',':id') }}";
