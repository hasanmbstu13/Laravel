...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="{{ route('project-admin.dashboard') }}">Home</a></li>
                ...
                <div class="sttabs tabs-style-line">
                    <div class="white-box">
                        <nav>
                            <ul>
                                <li>
                                    <a href="{{ route('project-admin.projects.show', $project->id) }}"><span>@lang('modules.projects.overview')</span></a>
                                </li>
                                <li>
                                    <a href="{{ route('project-admin.project-members.show', $project->id) }}"><span>@lang('modules.projects.members')</span></a>
                                </li>
                                <li>
                                    <a href="{{ route('project-admin.tasks.show', $project->id) }}"><span>@lang('app.menu.tasks')</span></a>
                                </li>
                                <li>
                                    <a href="{{ route('project-admin.files.show', $project->id) }}"><span>@lang('modules.projects.files')</span></a>
                                </li>
                                <li>
                                    <a href="{{ route('project-admin.invoices.show', $project->id) }}"><span>@lang('app.menu.invoices')</span></a>
                                </li>
                                <li>
                                    <a href="{{ route('project-admin.issues.show', $project->id) }}"><span>@lang('app.client') @lang('app.menu.issues')</span></a>
                                </li>
                                <li class="tab-current"><a
                                            href="{{ route('project-admin.time-logs.show', $project->id) }}"><span>@lang('app.menu.timeLogs')</span></a>
                                </li>
                            </ul>
                        </nav>
                    </div>
...
<script>
    var table = $('#timelog-table').dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{!! route('project-admin.time-logs.data', $project->id) !!}',
        deferRender: true,
        language: {
...
//        console.log(hours+" "+minutes);
    ...
    $('#save-form').click(function () {
        $.easyAjax({
            url: '{{route('project-admin.time-logs.store')}}',
            container: '#logTime',
            type: "POST",
    ...
    $('body').on('click', '.sa-params', function () {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('project-admin.time-logs.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    $('body').on('click', '.edit-time-log', function () {
        ...
        var url = '{{ route('project-admin.time-logs.edit', ':id')}}';
        url = url.replace(':id', id);
