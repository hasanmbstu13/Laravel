...
class ProjectAdminTimeLogsController extends ProjectAdminBaseController
{
    ...
    public function show($id) {
        ...
        return view('project-admin.projects.time-logs.show', $this->data);
    }
    ...
    public function edit($id) {
        ...
        return view('project-admin.projects.time-logs.edit', $this->data);
    }
    ...
    public function stopTimer(Request $request){
        ...
        $view = view('project-admin.projects.time-logs.active-timers', $this->data)->render();
