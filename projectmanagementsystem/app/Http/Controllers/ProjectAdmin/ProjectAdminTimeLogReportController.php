...
class ProjectAdminTimeLogReportController extends ProjectAdminBaseController
{
    ...
    public function index() {
        ...
        return view('project-admin.reports.time-log.index', $this->data);
    }
    ...
    public function store(Request $request) {
        ...
        $timeLog = ProjectTimeLog::select('start_time', DB::raw('DATE_FORMAT(start_time,\'%d/%M/%y\') as date'),DB::raw('sum(total_hours) as total_hours'))
