...
class ProjectAdminProjectMembersController extends ProjectAdminBaseController
{
    ...
    public function show($id)
    {
        ...
        return view('project-admin.projects.project-member.create', $this->data);
    }
