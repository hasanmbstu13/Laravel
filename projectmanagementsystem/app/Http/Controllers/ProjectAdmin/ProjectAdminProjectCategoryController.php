...
use App\Http\Controllers\ProjectAdmin\ProjectAdminBaseController;
use App\Http\Requests\Project\StoreProjectCategory;
use App\ProjectCategory;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;

class ProjectAdminProjectCategoryController extends ProjectAdminBaseController
{
    ...
    public function create()
    {
        ...
        return view('project-admin.project-category.create', $this->data);
    }
