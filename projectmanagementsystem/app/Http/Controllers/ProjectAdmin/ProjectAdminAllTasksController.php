...
class ProjectAdminAllTasksController extends ProjectAdminBaseController
{
    use ProjectProgress;
    ...
    public function index() {
        ...
        return view('project-admin.tasks.index', $this->data);
    }
    ...
    public function data($startDate = null, $endDate = null, $hideCompleted = null, $projectId = null) {
        ...
        return Datatables::of($tasks)
            ->addColumn('action', function($row){
                return '<a href="'.route('project-admin.all-tasks.edit', $row->id).'" class="btn btn-info btn-circle"
            ...
            ->editColumn('project_name', function ($row) {
                return '<a href="' . route('project-admin.projects.show', $row->project_id) . '">' . ucfirst($row->project_name) . '</a>';
            })
    ...
    public function edit($id) {
        ...
        $this->projects = Project::all();
        return view('project-admin.tasks.edit', $this->data);
    }
    ...
    public function create() {
        $this->projects = Project::all();
        return view('project-admin.tasks.create', $this->data);
    }

    public function membersList($projectId){
        $this->members = ProjectMember::byProject($projectId);
        $list = view('project-admin.tasks.members-list', $this->data)->render();
...
//      Send notification to user
        ...
        return Reply::redirect(route('project-admin.all-tasks.edit', $task->id), __('messages.taskCreatedSuccessfully'));
    }
