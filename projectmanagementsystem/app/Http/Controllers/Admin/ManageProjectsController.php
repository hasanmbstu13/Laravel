...
class ManageProjectsController extends AdminBaseController
{
    ...
    public function store(StoreProject $request) {
        ...
        return Reply::redirect(route('admin.projects.edit', [$project->id]), 'Project added successfully');
    }
...
//        $this->completedTasks = Task::projectCompletedTasks($this->project->id);
    ...
    public function update(StoreProject $request, $id) {
        ...
        return Reply::redirect(route('admin.projects.edit', $id), __('messages.projectUpdated'));
    }
