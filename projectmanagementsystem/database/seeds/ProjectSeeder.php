...
class ProjectSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $search->route_name = 'admin.tasks.show';
        $search->save();
        ...
        $invoice->invoice_number = '1495705966';
        ...
        $search->route_name = 'admin.invoices.show';
        $search->save();
        ...
        $invoice = new \App\Invoice();
        $invoice->project_id = $project->id;
        $invoice->invoice_number = '1495706231';
        ...
        $invoice = new \App\Invoice();
        $invoice->project_id = $project->id;
        $invoice->invoice_number = '1495707352';
